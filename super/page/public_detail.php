...
$querytotal = "SELECT COUNT(*) AS jml
            FROM tb_berkas, tb_jenis, tb_pengguna WHERE tb_berkas.id_jenis = tb_jenis.id_jenis AND tb_berkas.id_pengguna = tb_pengguna.id_pengguna AND tb_berkas.kat=0 AND tb_jenis.id_jenis = '$kodeJenis'";
...
<div class="intro-y grid grid-cols-12 gap-6 mt-5">
    ...
    <!-- BEGIN: Pagination -->
            ...
            <ul class="pagination">
                ...
                <li>
                    <a class="pagination__link" href="?public_detail&jenis=<?= $kodeJenis?>&halaman=<?= $halamanaktif - 1; ?>"> <i class="w-4 h-4" data-feather="chevrons-left"></i> </a>
                </li>
                <?php endif; ?>
                <?php for($i=$start_number;$i <= $end_number;$i++): ?>

                    <?php if($i == $halamanaktif): ?> 
                        <li> <a class="pagination__link pagination__link--active" href="?public_detail&jenis=<?= $kodeJenis?>&halaman=<?= $i; ?>"><?= $i; ?></a> </li>
                    <?php else : ?>
                        <li> <a class="pagination__link" href="?public_detail&jenis=<?= $kodeJenis?>&halaman=<?= $i; ?>"><?= $i; ?></a> </li>
                    <?php endif;  ?>
                <?php endfor; ?>
                <?php if($halamanaktif < $jumlahHalaman): ?>
                    <li>
                        <a class="pagination__link" href="?public_detail&jenis=<?= $kodeJenis?>&halaman=<?= $halamanaktif + 1; ?>"> <i class="w-4 h-4" data-feather="chevrons-right"></i> </a>
                    </li>
                <?php endif; ?>
            </ul>
        </div>
...
<script src="../dist/js/sidePublic.js"></script>