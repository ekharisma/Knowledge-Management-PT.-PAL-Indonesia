...
<div class="grid grid-cols-12 gap-6 mt-8">
    <div class="col-span-12 lg:col-span-3 xxl:col-span-2">
        ...
        <div class="intro-y box p-5 mt-6">
            <div class="mt-1">
                <a href="index.php?gambar" class="flex items-center px-3 py-2 rounded-md  bg-theme-1 text-white font-medium""> <i class="w-4 h-4 mr-2" data-feather="image"></i> Gambar </a>
