	...
	<div class="intro-y col-span-12">
		<div class="grid grid-cols-12 gap-5 mt-5 pt-5 border-t border-theme-5">
			...
			<ul class="pagination">
				...
				<li>
					<a class="pagination__link" href="?file&id_divisi=<?= $id_divisi; ?>&id=<?= $id_direktorat; ?>&jenis=<?= $id_jenis; ?>&halaman=<?= $halamanaktif - 1; ?>"> <i class="w-4 h-4" data-feather="chevrons-left"></i> </a>
				</li>
				<?php endif; ?>
				<?php for($i=$start_number;$i <= $end_number;$i++): ?>

					<?php if($i == $halamanaktif): ?> 
						<li> <a class="pagination__link pagination__link--active" href="?file&id_divisi=<?= $id_divisi; ?>&id=<?= $id_direktorat; ?>&jenis=<?= $id_jenis; ?>&halaman=<?= $i; ?>"><?= $i; ?></a> </li>
					<?php else : ?>
						<li> <a class="pagination__link" href="?file&id_divisi=<?= $id_divisi; ?>&id=<?= $id_direktorat; ?>&jenis=<?= $id_jenis; ?>&halaman=<?= $i; ?>"><?= $i; ?></a> </li>
					<?php endif;  ?>
				<?php endfor; ?>
				<?php if($halamanaktif < $jumlahHalaman): ?>
					<li>
						<a class="pagination__link" href="?file&id_divisi=<?= $id_divisi; ?>&id=<?= $id_direktorat; ?>&jenis=<?= $id_jenis; ?>&halaman=<?= $halamanaktif + 1; ?>"> <i class="w-4 h-4" data-feather="chevrons-right"></i> </a>
					</li>
				<?php endif; ?>
			</ul>
		</div>
