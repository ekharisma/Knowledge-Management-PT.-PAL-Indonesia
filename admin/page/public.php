...
$sql = "SELECT COUNT(tb_berkas.nama) as jumlah FROM tb_berkas WHERE tb_berkas.kat=0 AND tb_berkas.id_jenis = ?";
    ...
    <div class="col-span-12 xxl:col-span-9 grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 mt-8">
            ...
            <div class="grid grid-cols-12 gap-6 mt-5">
                <a href="index.php?public_detail&jenis=5" class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                    <div class="report-box zoom-in">
                        <div class="box p-5">
                            ...
                            <div class="text-base text-gray-600 mt-1">Gambar</div>
                        </div>
                    </div>
                </a>
                <a href="index.php?public_detail&jenis=3" class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                    <div class="report-box zoom-in">
                        <div class="box p-5">
                            <div class="flex">
                ...
                <a href="index.php?public_detail&jenis=1" class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                    <div class="report-box zoom-in">
                        <div class="box p-5">
                            <div class="flex">
                ...
                <a href="index.php?public_detail&jenis=2" class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                    <div class="report-box zoom-in">
                        <div class="box p-5">
                            <div class="flex">
                ...
                <a href="index.php?public_detail&jenis=4" class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                    <div class="report-box zoom-in">
                        <div class="box p-5">
                            <div class="flex">
                            ...
                            <div class="text-base text-gray-600 mt-1">Lain Lain</div>
                        </div>
                    </div>
                </a>
            </div>
