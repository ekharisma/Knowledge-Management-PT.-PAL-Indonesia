...
<div class="grid grid-cols-12 gap-6 mt-8">
    <div class="col-span-12 lg:col-span-3 xxl:col-span-2">
        ...
        <div class="intro-y box p-5 mt-6">
            <div class="mt-1">
                <a href="index.php?gambar" class="flex items-center px-3 py-2 rounded-md "> <i class="w-4 h-4 mr-2" data-feather="image"></i> Image </a>
                ...
                <a href="index.php?other" class="flex items-center px-3 py-2 mt-2 rounded-md bg-theme-1 text-white font-medium"> <i class="w-4 h-4 mr-2" data-feather="box"></i> Others </a>
            </div>
        </div>
                        ...
                        <div class="absolute top-0 right-0 mr-2 mt-2 dropdown ml-auto">
                            ...
                            <div class="dropdown-box w-40">
                                <div class="dropdown-box__content box dark:bg-dark-1 p-2">
                                    ...
                                    <a id="<?= $row['id_berkas'] ?>" href="<?= '../'.$url.$row['file']; ?>" download  data-toggle="modal" data-target="#button-modal-preview" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md unduh"> <i data-feather="box" class="w-4 h-4 mr-2"></i>Unduh</a>
